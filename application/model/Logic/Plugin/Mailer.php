...
class Logic_Plugin_Mailer {
   ...
   * @var string
   */
  public $From              = 'service@mobilefrom.com';

  /**
   * Sets the From name of the message.
   * @var string
   */
  public $FromName          = '机荒网客服邮箱';
  ...
  */
   ...
   * @var string
   */
  public $Username      = 'service@mobilefrom.com';

  /**
   * Sets SMTP password.
   * @var string
   */
  public $Password      = 'mf_2013';
 ...
 */
  ...
  public function SmtpConnect() {
    if(is_null($this->smtp)) {
      $this->smtp = Factory::getLogic('Plugin/Mailer/Smtp');
    }
  ...
  */
   ...
   * 发送SMTP邮件
   * @param 接收邮箱地址 $email
   * @param 接收用户名 $username
   * @param 邮件标题 $subject
   * @param 邮件内容 $body
   * @return boolean
   */
  public function SendSMTP($email, $username, $subject, $body)
  {
		$this->IsSMTP();
		$this->AddAddress($email, $username);
		$this->AddReplyTo('service@mobilefrom.com', '机荒网客服邮箱');
		$this->WordWrap = 50;
		$this->IsHTML(true);
